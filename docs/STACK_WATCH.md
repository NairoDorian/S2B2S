...
ZER0 is built on tools that move: Solid 2 is a release candidate, Tauri 2 and
Bun cut releases weekly, Tailwind and Oxlint ship continuously, and the
...
| `tauri`          | Tauri 2 docs (`tauri-apps/tauri-docs`)                                          |
