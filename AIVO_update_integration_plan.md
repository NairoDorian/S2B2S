...
> **STATUS: HISTORICAL — superseded by the M0–M5 roadmap in [`TAKEOVER.md`](TAKEOVER.md#4-sequential-roadmap--task-tracker-stateful-milestones).** Kept as an audit record of AIVORelay v1.0.24.
