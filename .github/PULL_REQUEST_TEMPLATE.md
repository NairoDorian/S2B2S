...
- [ ] I have searched [existing issues](https://github.com/cjpais/s2b2s/issues) and [pull requests](https://github.com/cjpais/s2b2s/pulls) (including closed ones) to ensure this isn't a duplicate
- [ ] I have read [CONTRIBUTING.md](https://github.com/cjpais/s2b2s/blob/main/CONTRIBUTING.md)
...
https://github.com/cjpais/s2b2s/discussions
