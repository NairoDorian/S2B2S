...
pub fn run(cli_args: CliArgs) {
    ...
    let specta_builder = Builder::<tauri::DynRuntime>::new()
        ...
        .commands(collect_commands![
            ...
            shortcut::change_multi_stt_extra_model_latency,
            shortcut::change_multi_stt_extra_model_translate,
            shortcut::change_multi_stt_extra_model_count,
            ...
            commands::models::benchmark_model_streaming,
