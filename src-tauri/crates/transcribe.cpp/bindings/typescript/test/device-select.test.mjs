...
modelTest(
  "model.device reports an index-less device that matches a registry entry",
  MODEL,
  async () => {
...
modelTest(
  "negative gpuDevice is rejected with InvalidArgument",
  MODEL,
  async () => {
...
modelTest(
  "out-of-range gpuDevice is rejected with InvalidArgument",
  MODEL,
  async () => {
...
modelTest(
  "selecting a GPU index under the cpu backend is rejected",
  MODEL,
  async () => {
