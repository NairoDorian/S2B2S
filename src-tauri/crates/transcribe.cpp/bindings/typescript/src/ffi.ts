...
export function bindLibrary(libraryPath: string): Bound {
  ...
  const F: Record<string, any> = {
    ...
    modelVariant: lib.func("transcribe_model_variant_string", "str", [
      "void *",
    ]),
    ...
    modelSupports: lib.func("transcribe_model_supports", "bool", [
      "void *",
      "int",
    ]),
    tokenize: lib.func("transcribe_tokenize", "int", [
      "void *",
      "str",
      "int32_t *",
      "size_t",
    ...
    detectedLanguage: lib.func("transcribe_detected_language", "str", [
      "void *",
    ]),
    returnedTimestampKind: lib.func(
      "transcribe_returned_timestamp_kind",
      "int",
      ["void *"],
    ),
    ...
    nSpeakerSegments: lib.func("transcribe_n_speaker_segments", "int", [
      "void *",
    ]),
    segmentInit: lib.func("transcribe_segment_init", "void", [
      outp(T.transcribe_segment),
    ]),
    wordInit: lib.func("transcribe_word_init", "void", [
      outp(T.transcribe_word),
    ]),
    tokenInit: lib.func("transcribe_token_init", "void", [
      outp(T.transcribe_token),
    ]),
    ...
    getWord: lib.func("transcribe_get_word", "int", [
      "void *",
      "int",
      iop(T.transcribe_word),
    ]),
    getToken: lib.func("transcribe_get_token", "int", [
      "void *",
      "int",
    ...
    timingsInit: lib.func("transcribe_timings_init", "void", [
      outp(T.transcribe_timings),
    ]),
    getTimings: lib.func("transcribe_get_timings", "int", [
      "void *",
    ...
    batchNSegments: lib.func("transcribe_batch_n_segments", "int", [
      "void *",
      "int",
    ]),
    ...
    batchNTokens: lib.func("transcribe_batch_n_tokens", "int", [
      "void *",
      "int",
    ]),
    batchNSpeakerSegments: lib.func(
      "transcribe_batch_n_speaker_segments",
      "int",
      ["void *", "int"],
    ),
    ...
    batchGetSpeakerSegment: lib.func(
      "transcribe_batch_get_speaker_segment",
      "int",
      ["void *", "int", "int", iop(T.transcribe_speaker_segment)],
    ),
    batchFullText: lib.func("transcribe_batch_full_text", "str", [
      "void *",
      "int",
    ]),
    batchRawText: lib.func("transcribe_batch_raw_text", "str", [
      "void *",
      "int",
    ]),
    batchDetectedLanguage: lib.func(
      "transcribe_batch_detected_language",
      "str",
      ["void *", "int"],
    ),
    batchReturnedTimestampKind: lib.func(
      "transcribe_batch_returned_timestamp_kind",
      "int",
      ["void *", "int"],
    ),
    ...
    streamTextInit: lib.func("transcribe_stream_text_init", "void", [
      outp(T.transcribe_stream_text),
    ]),
    ...
    streamLastStatus: lib.func("transcribe_stream_last_status", "int", [
      "void *",
    ]),
  };
...
export function abortProto(): any {
  return (abortProtoType ??= koffi.proto(
    "bool TranscribeAbortCb(void *udata)",
  ));
}

/** koffi proto for the log callback: `void (int level, const char *msg, void *ud)`. */
export function logProto(): any {
  return (logProtoType ??= koffi.proto(
    "void TranscribeLogCb(int level, const char *msg, void *udata)",
  ));
}
