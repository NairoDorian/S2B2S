...
if (!entry || !model || !audio) {
  console.log(
    "skip: set TS_PKG_ENTRY + TRANSCRIBE_SMOKE_MODEL + TRANSCRIBE_SMOKE_AUDIO",
  );
  process.exit(0);
}
...
console.log(
  `packed smoke: ${ok ? "PASS" : "FAIL"} (fromPackage=${fromPackage})`,
);
