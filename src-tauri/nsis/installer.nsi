; Custom NSIS template for s2b2s with portable mode support.
...
Function PageLeaveInstallType
  ...
  ${If} $0 = ${BST_CHECKED}
    ...
    ; --- PORTABLE MODE --- Switch default directory to Desktop\s2b2s for portable
...
Function .onInit
  ...
  ; or the legacy empty marker created by older s2b2s releases. Require Data/
...
Section Install
  ...
  ${If} $PortableMode = 1
    ...
    FileWrite $0 "s2b2s Portable Mode"
    FileClose $0
