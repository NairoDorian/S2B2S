...
import { KeyListenerShortcutInput } from "./KeyListenerShortcutInput";
 ...
 * - "key_listener": Uses KeyListenerShortcutInput with backend key events
 */
export const ShortcutInput: React.FC<ShortcutInputProps> = (props) => {
  ...
  if (keyboardImplementation === "key_listener") {
    return <KeyListenerShortcutInput {...props} />;
  }
