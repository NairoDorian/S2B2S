...
interface ModelsStore {
  ...
  setDownloadingModels: (downloadingModels: Record<string, true>) => void;
  setVerifyingModels: (verifyingModels: Record<string, true>) => void;
  setDownloadProgress: (
    downloadProgress: Record<string, DownloadProgress>,
  ) => void;
  setDownloadStats: (downloadStats: Record<string, DownloadStats>) => void;
}

const modelState = createSolidStore<ModelsStore>((set, get) => ({
  models: [],
  currentModel: "",
  downloadingModels: {},
  verifyingModels: {},
  ...
  setDownloadingModels: (downloadingModels) => set({ downloadingModels }),
  setVerifyingModels: (verifyingModels) => set({ verifyingModels }),
  setDownloadProgress: (downloadProgress) => set({ downloadProgress }),
  setDownloadStats: (downloadStats) => set({ downloadStats }),
